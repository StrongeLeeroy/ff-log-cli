...
enum Command {
    ...
    List {
        ...
        #[arg(short, long, default_value = "default", help = "Path to log directory or 'default' for auto-detection")]
        fflogs_dir: String,
    },
